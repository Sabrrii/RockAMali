...
public:
  ...
  )
  {
    ...
    factory_types.push_back      ("program_image1d")  ;if(name == factory_types.back())
      return new CDataProcessorGPU_opencl_image1d<Tdata,Tproc, Taccess>(lock,device,VECTOR_SIZE,wait_status,set_status,wait_statusR,set_statusR,do_check);
//    if(name == "error")
