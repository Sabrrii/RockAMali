...
do
  ./process_sequential -s 4096 -o sample_sequential.nc -r result_sequential.nc --generator-factory count --CPU-factory kernel -n 12 --use-GPU --GPU-factory $f --do-check 2>/dev/null | grep 'test:'
done
