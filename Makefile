...
##AMD64 (gan*)
	LIB_NETCDF= -I../NetCDF/include/ -lnetcdf_c++ -L../NetCDF/lib/ -L/usr/lib/x86_64-linux-gnu/  -lnetcdf -I../NetCDF.Tool/ -I../CImg.Tool/
else
##ARM64 (RockPro64)
...
SRC_DATA_PROCESS=CDataProcessor.hpp CDataProcessor_vMvPv.hpp CDataProcessor_vMcPc.hpp CDataProcessor_energy.hpp CDataProcessorGPU.hpp CL_image_data_type.h CDataProcessorGPUopencl.hpp CDataProcessorGPU_vMcPc.hpp CDataProcessorGPU_energy.hpp CDataProcessorGPUfactory.hpp CProfiling.hpp
...
process_sequential_run:
	...
	ncdump -h sample_sequential.nc | tee sample_sequential.cdl; ncdump -h result_sequential.nc | tee result_sequential.cdl
	git add result_sequential.cdl sample_sequential.cdl
	ncdump -h pac_signal_parameters.nc | tee pac_signal_parameters.cdl
	git add pac_signal_parameters.cdl
	ncdump -h profiling_process.nc | tee profiling_process.cdl; ncdump -h profiling_gpu.nc | tee profiling_gpu.cdl
	git add profiling_gpu.cdl profiling_process.cdl
